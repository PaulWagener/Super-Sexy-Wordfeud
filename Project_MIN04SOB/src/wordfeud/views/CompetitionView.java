...
public class CompetitionView extends CorePanel {
	...
	public CompetitionView() {
		...
		setLayout(new MigLayout(
				"",
				"[75px:n][:400px:1000px,growprio 70,grow 250][250px,growprio 30,grow][150px:n][57.00]",
				"[20px:20px:20px][150px:550px:550px,grow][25px:25px:25px]"));
		...
		playerList.addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent arg0) {
				if (actionButton.getText().equals(
						...
						|| actionButton.getText().equals("Speler uitdagen")) {
					actionButton.setEnabled(true);
				}
			}
		});
	...
	/*
	 * public void fillAvailableCompetitions(CompetitionModel[]
	...
	public void setText(String labelText, String labelText2, String button,
			boolean visible) {
	...
	/*
	 * / Competitie deelnemen 1 uitdaging per tegenstander Verwijderen uit
	 * Competitie Verwijder Competitie Speler uitdagen /
	 */
