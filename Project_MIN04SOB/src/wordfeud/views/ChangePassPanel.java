...
public class ChangePassPanel extends CorePanel {
	...
	private JLabel oldPassLabel, newPass1Label, newPass2Label, oldPassResult,
			newPass1Result, newPass2Result;
	...
	public ChangePassPanel() {
		...
		setLayout(new MigLayout("", "[120px][100.00px][115.00px][100px]",
				"[30px][30px][30px][30px]"));
